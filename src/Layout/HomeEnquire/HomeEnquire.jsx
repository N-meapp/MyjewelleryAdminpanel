    ...
    return (
      <div className="mt-8 md:mt-24 lg:mt-[200px]">
        ...
        <div className="flex items-center justify-center w-full px-4">
          <hr className="hidden md:block flex-grow border-t border-[#000000]" />
          <div className="flex items-center">
            <p className="text-[#000000] text-xl md:text-2xl lg:text-[30px] font-semibold">Connect with us</p>
            <img
        ...
        <div className="px-4 py-8 md:px-12 md:py-12 lg:px-[250px] lg:py-[100px]">
          <div className="flex flex-col md:flex-row gap-8 md:gap-0">
            ...
            <div className="w-full md:w-8/12 flex justify-center items-center mt-4 md:mt-0">
              <div className="w-full p-4 md:p-6 md:border border-[#7b8278] rounded-[20px] md:ml-[-40px] bg-white">
                {/* Title */}
                <div className="flex items-start gap-2 pl-2 md:pl-[60px] lg:pl-[80px]">
                  ...
                  <p className="text-sm md:text-base lg:text-lg font-semibold text-[#563a14]">
                    Looking for something special?!
                  </p>
                </div>
  
                {/* Contact details grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-y-4 gap-x-4 mt-6 pl-2 md:pl-[60px] lg:pl-[80px] pb-10 md:pb-[60px] contact">
                  <div className="block">
                    <div className="flex items-start gap-3 mb-1">
                      ...
                      <p className="text-[#563a14] text-xs md:text-sm font-semibold">+91 23456 7899</p>
                    </div>
                  </div>
                  ...
                  <div className="block">
                    <div className="flex items-start gap-3 mb-1">
                      ...
                      <p className="text-[#563a14] text-xs md:text-sm font-semibold">Visit our website</p>
                    </div>
                  </div>
                  ...
                  <div className="block">
                    <div className="flex items-start gap-3 mb-1">
                      ...
                      <p className="text-[#563a14] text-xs md:text-sm font-semibold">myjewlry@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="block">
                    <div className="flex items-start gap-3 mb-1">
                      ...
                      <p className="text-[#563a14] text-xs md:text-sm font-semibold">Eranakulam, Kochi</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  <button
                    type="button"
                    className="px-6 sm:px-8 md:px-[60px] py-2.5 text-sm font-medium text-white bg-[#88704f] hover:bg-[#594933] rounded-[8px] transform translate-y-4"
                  >
                    Enquire Now
                  </button>
                </div>
