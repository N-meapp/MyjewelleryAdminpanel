              ...
              <div class="relative w-full">
                ...
                <div className='bg-gray-50 border border-[#AF9F9F] px-6 py-[2px] rounded-[21px]'>
                  <input
                    ...
                    type="text" id="simple-search" class="bg-gray-50 text-gray-900 text-sm rounded-[19px] w-full ps-10 p-2.5 focus:outline-none dark:placeholder-gray-400 dark:text-white" placeholder="Search for Gold Jewellery, Diamond Jewellery...." required />
                </div>
              </div>
            </form>
          </div>
