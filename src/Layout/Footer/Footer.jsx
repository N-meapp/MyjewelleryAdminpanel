            ...
            <div className="px-6 md:px-16 lg:px-24 py-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-6">
                        ...
                        <div className="w-[80%] md:w-[100%] h-[56px] md:h-[76px] bg-[#d1c1ad] md:rounded-[22px] rounded-[12px] flex items-center pl-4 pr-2 gap-2 md:gap-4 mt-8">
                            <input
                                type="email"
                ...
                {/* Bottom - Social Icons */}
                <div className="flex justify-center md:justify-end mt-12 md:mr-[100px] gap-4">
