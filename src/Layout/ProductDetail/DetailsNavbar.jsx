...
const DetailsNavbar = () => {
  return (
    <div className='w-[90%] mx-auto h-[60px] md:mt-[49px] mt-[10px] flex justify-between'>
    ...
    <div className='flex gap-3 items-center'>
      ...
      <svg className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#513535" className="absolute right-[35px] md:hidden  top-[30px] size-[17px]">
